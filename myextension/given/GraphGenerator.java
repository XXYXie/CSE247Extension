 ...
 * to be used to test students' Dijkstra's Algorithm and Bellman–Ford Algorithm Implementations
 * 
 * @author timhuber
 *
 */
public class GraphGenerator {
	...
	public void addEdgeWithVertex() {
		...
		//
		int totalWeight = dDist + r.nextInt(2) + 1;

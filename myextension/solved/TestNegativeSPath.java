...
public class TestNegativeSPath {
	...
	@Test
	public void test() {
		int[] shortestPathLengths = { 3,  4,  5, 6, 8, 10, 50, 100};
		int[] totalVertices       = { 5,  8, 10, 12, 16, 20, 75, 200};
		int[] totalEdges          = {10, 16, 20, 24, 32, 50, 300, 400};
...
//		outputPath   = sp.returnPath(gg.end());
		...
		NegativeSPath nsp = new NegativeSPath(g, gg.start(), gg.weights());
		nsp.run();
		
		expectedPath = gg.getShortestPath();
		outputPath   = nsp.returnPath(gg.end());
